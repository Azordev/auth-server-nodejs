const root = async (req, res) => {
  const info = [
    {
      path: '/api/v1/auth',
      url: 'https://azordev-auth.herokuapp.com/api/v1/auth',
    ...
    },
    {
      ...
      url: 'https://azordev-auth.herokuapp.com/api/v1/auth/login',
      description:
    ...
    },
    {
      ...
      url: 'https:/azordev-auth.herokuapp.com/api/v1/auth/signup',
      description:
